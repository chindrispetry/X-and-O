...
#include "x si 0.h"
using namespace std;
void tabla::calculator_hard(int nr_calc, int &k){
    int i,j;
    ...
    if(t[0][0]==0 || t[0][0]==nr_calc && t[1][1]==0 || t[1][1]==nr_calc &&t[2][2]==0 || t[2][2]==nr_calc && k!=0){
        ...
        if(t[1][1]==0 && t[2][2]==nr_calc && t[0][0] && k!=0){
            t[1][1]=nr_calc;
            k=0;
        }
    }
    if(t[2][0]==0 || t[2][0]==nr_calc && t[2][2]==0 || t[2][2]==nr_calc && t[0][2]==0 || t[0][2]==nr_calc && t[2][1]==0 ||t[2][1]==nr_calc && t[1][2]==0 ||t[1][2]==nr_calc && k!=0){
        if(t[2][0]==0 && k!=0){
            t[2][0]=nr_calc;
            k=0;
        }
        ...
        if(t[2][0]==nr_calc && t[2][2]==nr_calc &&t[2][1]==0 && k!=0){
            t[2][1]=nr_calc;
            k=0;
        }
        if(t[0][2]==nr_calc && t[2][2]==nr_calc && t[1][2]==0 && k!=0){
            t[1][2]=nr_calc;
            k=0;
        }
    }
    if(t[2][0]==0 || t[2][0]==nr_calc && t[1][0]==0 || t[1][0]==nr_calc && t[0][0]==0 || t[0][0]==nr_calc && t[0][1]==0 ||t[0][1]==nr_calc && t[0][2]==0 ||t[0][2]==nr_calc && k!=0){
        if(t[2][0]==0 && k!=0){
            t[2][0]=nr_calc;
            k=0;
        }
        ...
        if(t[2][0]==nr_calc && t[0][0]==nr_calc &&t[1][0]==0 && k!=0){
            t[1][0]=nr_calc;
            k=0;
        }
        if(t[0][0]==nr_calc && t[0][2]==nr_calc && t[0][1]==0 && k!=0){
            t[0][1]=nr_calc;
            k=0;
        }
    }
